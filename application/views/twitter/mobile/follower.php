...
if ($user_sign!=FALSE):
	...
	$followers = $twitteroauth->get('followers/list', array('cursor'=>$cursor));
?>
...
<body id="mobile">
	...
	<?php foreach ($followers->users as $user) : ?>
	<div class="tweets">
	...
	<?php endforeach; ?>
	<ul class="pagination">
		<?php if ($followers->previous_cursor_str==0) : ?>
			<li class="unavailable arrow"><a href="<?php echo(base_url("mobile/follower/{$followers->previous_cursor_str}")); ?>">&laquo; prev</a></li>
		<?php else : ?>
		<li class="arrow"><a href="<?php echo(base_url("mobile/follower/{$followers->previous_cursor_str}")); ?>">&laquo; prev</a></li>
		<?php endif; ?>
		<li class="arrow"><a href="<?php echo(base_url("mobile/follower/{$followers->next_cursor_str}")); ?>">next &raquo;</a></li>
	</ul>
</body>
</html>
